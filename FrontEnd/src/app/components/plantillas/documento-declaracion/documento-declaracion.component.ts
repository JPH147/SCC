...
@Component({
  selector: 'app-documento-declaracion',
  templateUrl: './documento-declaracion.component.html',
  styleUrls: ['./documento-declaracion.component.css']
})
export class DocumentoDeclaracionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ListadoPlantillas.CargarInformacion(3,0,"",1,10) ;
  ...
  EstablecerPlantillaPrimaria(plantilla) {
    ...
    let nombre_archivo = "ddjj_X.docx" ;
