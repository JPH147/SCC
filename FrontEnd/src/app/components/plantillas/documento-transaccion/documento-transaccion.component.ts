...
@Component({
  selector: 'app-documento-transaccion',
  templateUrl: './documento-transaccion.component.html',
  styleUrls: ['./documento-transaccion.component.css']
})
export class DocumentoTransaccionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ListadoPlantillas.CargarInformacion(1,0,"",1,10) ;
  ...
  EstablecerPlantillaPrimaria(plantilla) {
    ...
    let nombre_archivo = "transaccion_X.docx" ;
