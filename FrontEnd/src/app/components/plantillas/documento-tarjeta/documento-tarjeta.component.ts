...
@Component({
  selector: 'app-documento-tarjeta',
  templateUrl: './documento-tarjeta.component.html',
  styleUrls: ['./documento-tarjeta.component.css']
})
export class DocumentoTarjetaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ListadoPlantillas.CargarInformacion(4,0,"",1,10) ;
  ...
  EstablecerPlantillaPrimaria(plantilla) {
    ...
    let nombre_archivo = "tarjeta_X.docx" ;
