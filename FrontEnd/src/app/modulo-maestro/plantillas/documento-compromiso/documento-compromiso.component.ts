...
@Component({
  selector: 'app-documento-compromiso',
  templateUrl: './documento-compromiso.component.html',
  styleUrls: ['./documento-compromiso.component.css']
})
export class DocumentoCompromisoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ListadoPlantillas.CargarInformacion(5,0,"",1,10) ;
  ...
  EstablecerPlantillaPrimaria(plantilla) {
    ...
    let nombre_archivo = "compromiso_X.docx" ;
