...
@Component({
  selector: 'app-documento-autorizacion',
  templateUrl: './documento-autorizacion.component.html',
  styleUrls: ['./documento-autorizacion.component.css']
})
export class DocumentoAutorizacionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ListadoPlantillas.CargarInformacion(2,0,"",1,10) ;
  ...
  EstablecerPlantillaPrimaria(plantilla) {
    ...
    let nombre_archivo = "autorizacion_X.docx" ;
