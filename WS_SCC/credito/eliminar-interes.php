<?php
    ...
    try
    {
      ...
      if (($_POST["prcredito"])!=null)
      {
        ...
        if($credito->eliminar_interes_credito())
        {
          print_json("0000", "Se eliminó el interés satisfactoriamente.", true);
        }
        else
        {
          print_json("9999", "Ocurrió un error al eliminar el interés.", false);
        }
      }
      else
      {
