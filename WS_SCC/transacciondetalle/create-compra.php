<?php
    ...
    try
    {
        ...
        if (($_POST["prcabecera"])!=null)
        {
            ...
            $transaccion->id_producto = trim($_POST["prproducto"]);
            $transaccion->producto_serie = trim($_POST["prserie"]);
            $transaccion->color =  trim($_POST["prcolor"]);
            $transaccion->almacenamiento = trim($_POST["pralmacenamiento"]);
