<?php
    ...
    try
    {
        ...
        if  if (($_POST["pprv_idtipodocumento"])!=null)
            && !empty(trim($_POST["prv_tipo_documento"]))
            && !empty(trim($_POST["prv_documento"])) && !empty(trim($_POST["prv_nombre"])) && !empty(trim($_POST["prv_representante_legal"]))
